    ...
    return (
      ...
      >
        ...
        <textarea
          ...
          className='mb-2 h-48 w-96 resize-none rounded-xl bg-input px-12 py-4 text-orange outline-none placeholder:text-inputText focus:ring-2 focus:ring-orange focus:placeholder:text-orange data-[errored=true]:text-red data-[errored=true]:ring-2 data-[filled=true]:ring-2 data-[errored=true]:ring-red data-[filled=true]:data-[errored=false]:ring-orange data-[errored=true]:placeholder:text-red'
        />
      </div>
    );
  }
